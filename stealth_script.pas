...
type
  ...
  TEvMessengerEventCallBack = procedure(MesID : Byte; SenderNickName : String; SenderId, ChatId : String; EventMsg : String; EventCode : Byte); stdcall;
...
{$Region 'Script classes(records)'}
  ...
  TTelegramMessenger = record
    ...
    public
      ...
      function MessengerName : String;
      property Connected : Boolean read GetConnected write SetConnected;
      property Token : String read GetToken write SetToken;
  end;

  TViberMessenger = record
    private
      function GetConnected : Boolean;
      procedure SetConnected(Value : Boolean);
      function GetToken : String;
  ...
  TMover = record
    private
      ...
      procedure SetMoveCheckStamina(Value : Word);
      function GetMoveCheckStamina : Word;
      procedure SetMoveTurnCost(Value : Integer);
      function GetMoveTurnCost : Integer;
      procedure SetMoveBetweenTwoCorners(Value : Boolean);
      function GetMoveBetweenTwoCorners : Boolean;
    ...
    public
      ...
      property MoveCheckStamina : Word read GetMoveCheckStamina write SetMoveCheckStamina;
      property MoveTurnCost : Integer read GetMoveTurnCost write SetMoveTurnCost;
      property MoveBetweenTwoCorners : Boolean read GetMoveBetweenTwoCorners write SetMoveBetweenTwoCorners;
  end;
  ...
  TConnection = record
    ...
    public
      ...
      procedure SetARExtParams(ShardName : String; CharName : String; UseAtEveryConnect: Boolean);
  ...
  TScript = record
    ...
    public
      ...
      HTTP : THTTP;
      ICQ : TICQ;
      TelegramMessenger : TTelegramMessenger;
      ViberMessenger : TViberMessenger;
      DiscordMessenger: TDiscordMessenger;
      Client : TClient;
      Skill : TSkill;
      Mover : TMover;
...
procedure Script_SetARExtParams(ShardName : PChar; CharName : PChar; UseAtEveryConnect: Boolean); stdcall; external ConstScriptDLL name 'Script_SetARExtParams';
{$EndRegion}
{$Region 'Self'}
...
{$EndRegion}
{$Region 'Messenger'}
function Script_Messenger_GetConnected(MesID : Byte) : Boolean; stdcall;external ConstScriptDLL name 'Script_Messenger_GetConnected';
procedure Script_Messenger_SetConnected(MesID : Byte; Value : Boolean); stdcall;external ConstScriptDLL name 'Script_Messenger_SetConnected';
function Script_Messenger_GetToken(MesID : Byte) : PChar; stdcall; external ConstScriptDLL name 'Script_Messenger_GetToken';
procedure Script_Messenger_SetToken(MesID : Byte; Value : PChar); stdcall; external ConstScriptDLL name 'Script_Messenger_SetToken';
function Script_Messenger_GetName(MesID : Byte) : PChar; stdcall; external ConstScriptDLL name 'Script_Messenger_GetName';
procedure Script_Messenger_SendMessage(MesID : Byte; Msg : PChar; UserID : PChar); stdcall; external ConstScriptDLL name 'Script_Messenger_SendMessage';
{$EndRegion}
{$Region 'Client work'}
...
procedure Script_MoverStop; stdcall; external ConstScriptDLL name 'Script_MoverStop';
...
procedure Script_SetMoveCheckStamina(Value : Word); stdcall; external ConstScriptDLL name 'Script_SetMoveCheckStamina';
function Script_GetMoveCheckStamina : Word; stdcall; external ConstScriptDLL name 'Script_GetMoveCheckStamina';
procedure Script_SetMoveTurnCost(Value : Integer); stdcall; external ConstScriptDLL name 'Script_SetMoveTurnCost';
function Script_GetMoveTurnCost : Integer; stdcall; external ConstScriptDLL name 'Script_GetMoveTurnCost';
procedure Script_SetMoveBetweenTwoCorners(Value : Boolean); stdcall; external ConstScriptDLL name 'Script_SetMoveBetweenTwoCorners';
function Script_GetMoveBetweenTwoCorners : Boolean; stdcall; external ConstScriptDLL name 'Script_GetMoveBetweenTwoCorners';
...
procedure TConnection.SetARExtParams(ShardName : String; CharName : String; UseAtEveryConnect: Boolean);
begin
  Script_SetARExtParams(PChar(ShardName),PChar(CharName),UseAtEveryConnect);
end;
...
{$Region 'Messenger'}
function TTelegramMessenger.GetConnected : Boolean;
begin
  Result := Script_Messenger_GetConnected(1);
end;
procedure TTelegramMessenger.SetConnected(Value : Boolean);
begin
  Script_Messenger_SetConnected(1, Value);
end;

function TTelegramMessenger.GetToken : String;
begin
  Result := String(Script_Messenger_GetToken(1));
end;
procedure TTelegramMessenger.SetToken(Value : String);
begin
  Script_Messenger_SetToken(1, PChar(Value));
end;

procedure TTelegramMessenger.SendMessage(Msg : String; UserID : String);
begin
  Script_Messenger_SendMessage(1, PChar(Msg), PChar(UserID));
end;

function TTelegramMessenger.MessengerName : String;
begin
  Result := String(Script_Messenger_GetName(1));
end;
...
function TViberMessenger.GetConnected : Boolean;
begin
  Result := Script_Messenger_GetConnected(2);
end;

procedure TViberMessenger.SetConnected(Value : Boolean);
begin
  Script_Messenger_SetConnected(2, Value);
end;

function TViberMessenger.GetToken : String;
begin
  Result := String(Script_Messenger_GetToken(2));
end;
procedure TViberMessenger.SetToken(Value : String);
begin
  Script_Messenger_SetToken(2, PChar(Value));
end;

procedure TViberMessenger.SendMessage(Msg : String; UserID : String);
begin
  Script_Messenger_SendMessage(2, PChar(Msg), PChar(UserID));
end;

function TViberMessenger.MessengerName : String;
begin
  Result := String(Script_Messenger_GetName(2));
end;


function TDiscordMessenger.GetConnected : Boolean;
begin
  Result := Script_Messenger_GetConnected(3);
end;

procedure TDiscordMessenger.SetConnected(Value : Boolean);
begin
  Script_Messenger_SetConnected(3, Value);
end;

function TDiscordMessenger.GetToken : String;
begin
  Result := String(Script_Messenger_GetToken(3));
end;
procedure TDiscordMessenger.SetToken(Value : String);
begin
  Script_Messenger_SetToken(3, PChar(Value));
end;

procedure TDiscordMessenger.SendMessage(Msg : String; UserID : String);
begin
  Script_Messenger_SendMessage(3, PChar(Msg), PChar(UserID));
end;

function TDiscordMessenger.MessengerName : String;
begin
  Result := String(Script_Messenger_GetName(3));
end;
...
procedure TMover.SetMoveCheckStamina(Value : Word);
begin
  Script_SetMoveCheckStamina(Value);
end;

function TMover.GetMoveCheckStamina : Word;
begin
  Result := Script_GetMoveCheckStamina;
end;

procedure TMover.SetMoveTurnCost(Value : Integer);
begin
  Script_SetMoveTurnCost(Value);
end;

function TMover.GetMoveTurnCost : Integer;
begin
  Result := Script_GetMoveTurnCost;
end;

procedure TMover.SetMoveBetweenTwoCorners(Value : Boolean);
begin
  Script_SetMoveBetweenTwoCorners(Value);
end;

function TMover.GetMoveBetweenTwoCorners : Boolean;
begin
  Result := Script_GetMoveBetweenTwoCorners;
end;
...
//  Move(GumpInfoStream.Memory^,n,20);
  ...
  for I := 0 to ArrLen - 1 do
  begin
    GumpInfoStream.Read(Result.Tooltips[i].Cliloc_ID,4);
    Result.Tooltips[i].Arguments := ReadStringParam(GumpInfoStream);
